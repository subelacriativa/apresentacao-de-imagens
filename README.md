...
<head>
    ...
    <style>
        * {
        ...
        /* Ícones decorativos flutuantes (Bigode / Gravata simulados em texto/CSS) */
        .decor {
            font-size: 24px;
...
<script>
    ...
    // Função principal que gerencia a exibição
    function showSlides() {
        let i;
        ...
        // Se passar do limite, volta para o primeiro
        ...
        // Programa a próxima troca automática para daqui a 4 segundos (tempo melhor para leitura)
        slideTimeout = setTimeout(showSlides, 4000); 
    }

    // Controle manual corrigido
    function plusSlides(n) {
        // Interrompe o timer atual para evitar choque com o clique
        clearTimeout(slideTimeout); 
        
        // Ajusta o slideIndex com base na direção
        slideIndex += (n - 1);
        ...
        // Executa a função para atualizar a imagem e reiniciar o timer de 4s
        showSlides();
    }
</script>
